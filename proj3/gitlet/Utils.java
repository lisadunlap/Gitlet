...
class Utils {
    ...
    /**Write contents of file name FILE with objects CONTENTS.*/
    static void writeContents(String file, Object... contents) {
        File f = new File(file);
        writeContents(f, contents);
    }

    /**Append contents CONTENTS to file name FILE.*/
    static void appendContents(String file, String contents) {
        try {
    ...
    /** Write OBJ to file name FILE. */
    static void writeObject(String file, Serializable obj) {
        File f = new File(file);
        writeObject(f, obj);
    }
    ...
    static ArrayList<String> plainFilenamesIn(File dir) {
     ...
     *  lexicographic order as Java Strings.  Returns null if DIR does
     *  not denote a directory. */
    static ArrayList<String> plainFilenamesIn(String dir) {
    ...
    /**Prints out an error message MSG and then terminates.*/
